    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center w-full">
            ...
            <div className={`hidden md:flex space-x-8 font-medium text-white`}>
                <Link to="/" className="hover:text-accent-cyan transition-colors duration-200">Home</Link>
                <Link to="/about" className="hover:text-accent-cyan transition-colors duration-200">About Us</Link>
                <Link to="/blogs" className="hover:text-accent-cyan transition-colors duration-200">Blogs</Link>
            </div>
            <Link to="/contact">
