...
const FaqItem = ({ item, isOpen, onClick }) => (
    <div className="border-b border-white/20">
        <button onClick={onClick} className="w-full text-left py-4 flex justify-between items-center">
            ...
            <ChevronDown className={`w-5 h-5 text-accent-cyan transform transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} />
        </button>
...
export const FaqSection = () => {
    ...
    return (
        <section id="faqs" className="py-20 bg-dark-background text-white">
